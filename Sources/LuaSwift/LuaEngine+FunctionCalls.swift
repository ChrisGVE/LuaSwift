...
//  Calls are bounded by the instruction hook and classified via
//  errorFromCode (both LuaEngine+Execution.swift). The inverse
//  direction — Lua calling Swift — lives in LuaEngine+Callbacks.swift.
//
