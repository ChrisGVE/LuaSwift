...
// NOTE: This file holds the version-gated constants and the Lua 5.1/5.2
// compatibility shims only. The version-agnostic C-macro wrappers (stack, type,
// function calls, registration, binary-safe strings) live in
// LuaHelpers+CMacros.swift; the structured runtime-error machinery
// (walkLuaStack, buildTraceback, runtimeErrorHandler) lives in
