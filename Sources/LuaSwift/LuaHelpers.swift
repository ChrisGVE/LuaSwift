...
// NOTE: The structured runtime-error machinery (walkLuaStack, buildTraceback,
// runtimeErrorHandler) lives in LuaErrorHandler.swift. This file retains only
// the C-macro shims and binary-safe string helpers.
