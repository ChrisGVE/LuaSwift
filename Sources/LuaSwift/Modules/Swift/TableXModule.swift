...
public struct TableXModule {
  ...
  private static func deepcopy(_ value: LuaValue, seen: inout [ObjectIdentifier: LuaValue])
    -> LuaValue
  {
    switch value {
    case .table(let dict):
  ...
  private static func deepmerge(_ t1: [String: LuaValue], _ t2: [String: LuaValue]) -> [String:
    LuaValue]
  {
    var result = t1
